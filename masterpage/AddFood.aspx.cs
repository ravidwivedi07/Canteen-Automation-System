...
public partial class AddFood : System.Web.UI.Page
{
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand();
        con.ConnectionString = "Data Source=LAPTOP-T5I17ICE;Initial Catalog=Canteen Management System;Integrated Security=True";
        cmd.CommandText = "Insert into addfood(category,foodname,amount,productname,productid,quantity) values('" + DropDownList2.Text + "','" + txtname.Text + "','" + txtamnt.Text + "','" + DropDownList1.Text + "','" + txtId.Text + "','" + txtquant.Text + "')";
        con.Open();
        cmd.Connection = con;
        cmd.ExecuteNonQuery();
        con.Close();

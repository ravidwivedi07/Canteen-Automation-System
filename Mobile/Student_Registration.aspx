<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Student_Registration.aspx.cs" Inherits="MobileSystem.Mobile.Student_Registration" %>
				...
				<div class="main-login main-center">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<asp:TextBox runat="server" CssClass="form-control" ID="pass_txt" placeholder="Enter your Password" ValidationGroup="Validation" TextMode="Password" />
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<asp:TextBox runat="server" CssClass="form-control" ID="confpass_txt" placeholder="Confirm password"  ValidationGroup="Validation" TextMode="Password" />
						...
						<div class="login-register">
				            <asp:Button runat="server" ID="Button2"  text="Login" OnClick="btnLogin_Click"/> 
				         </div>

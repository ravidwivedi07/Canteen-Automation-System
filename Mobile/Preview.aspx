<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Preview.aspx.cs" Inherits="MobileSystem.Mobile.Preview" %>
		...
		<div class="container">
			<div class="row main">
				...
				<div class="main-login main-center">
						...
						<div class="form-group">
							<label for="pre_pass_txt" Visible="False" class="cols-sm-2 control-label">Password</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<asp:TextBox runat="server" CssClass="form-control" ID="pre_pass_txt" ReadOnly="True" TextMode="Password" Visible="False" />
								</div>
							</div>
						</div>

						<div class="form-group">
                            <label for="pre_confpass_text" Visible="False"  class="cols-sm-2 control-label">Confirm Password</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<asp:TextBox runat="server" Visible="False"  CssClass="form-control" ID="pre_confpass_txt" ReadOnly="True" TextMode="Password" />
								</div>
							</div>
						</div>
